...
class ListFormContainer extends Component {
    ...
    render() {
        ...
        const descriptionPlaceholder = action === "new-list" ? "Description" : null

        const titleValue = action === "edit-list" ? title : null
        const descriptionValue = action === "edit-list" ? description : null
